...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "E-111" then
ESP:AddObjectListener(Workspace.Entities["E-111"], { 
    Name = "Torso", 
    CustomName = 'E-111', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Romplian" then
ESP:AddObjectListener(Workspace.Entities["Romplian"], { 
    Name = "Torso", 
    CustomName = 'Romplian', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Yellow Romplian" then
ESP:AddObjectListener(Workspace.Entities["Yellow Romplian"], { 
    Name = "Torso", 
    CustomName = 'Yellow Romplian', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Green Romplian" then
ESP:AddObjectListener(Workspace.Entities["Green Romplian"], { 
    Name = "Torso", 
    CustomName = 'Green Romplian', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Blue Romplian" then
ESP:AddObjectListener(Workspace.Entities["Blue Romplian"], { 
    Name = "Torso", 
    CustomName = 'Blue Romplian', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Purple Romplian" then
ESP:AddObjectListener(Workspace.Entities["Purple Romplian"], { 
    Name = "Torso", 
    CustomName = 'Purple Romplian', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "BOBUMTSKING" then
ESP:AddObjectListener(Workspace.Entities["BOBUMTSKING"], { 
    Name = "Torso", 
    CustomName = 'Bobumtsking', 
    Color = Color3.fromRGB(255, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "ah221" then
ESP:AddObjectListener(Workspace.Entities["ah221"], { 
    Name = "Torso", 
    CustomName = 'the crime', 
    Color = Color3.fromRGB(0, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "ah246" then
ESP:AddObjectListener(Workspace.Entities["ah246"], { 
    Name = "Torso", 
    CustomName = 'the crime', 
    Color = Color3.fromRGB(182, 0, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "BLOODCONE-7" then
ESP:AddObjectListener(Workspace.Entities["BLOODCONE-7"], { 
    Name = "Torso", 
    CustomName = 'BLOODCONE-7', 
    Color = Color3.fromRGB(255, 0, 0), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "Boah" then
ESP:AddObjectListener(Workspace.Entities.["Boah"], { 
    Name = "Torso", 
    CustomName = 'Boah', 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "BFK-10" then
ESP:AddObjectListener(Workspace.Entities.["BFK-10"], { 
    Name = "Torso", 
    CustomName = 'BFK-15', 
    Color = Color3.fromRGB(255, 0, 64), -- Color
    IsEnabled = "whatever" 
...
ESP:AddObjectListener(Workspace.Entities.["RVR-10"], { 
    Name = "Torso", 
    CustomName = 'RVR-15', 
    Color = Color3.fromRGBrgb(255, 106, 0), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
end
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "ULB-15" then
ESP:AddObjectListener(Workspace.Entities.["ULB-15"], { 
    Name = "Torso", 
    CustomName = 'ULB-15', 
    Color = Color3.fromRGB(0, 255, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "TLAB-15" then
ESP:AddObjectListener(Workspace.Entities.["TLAB-15"], { 
    Name = "Torso", 
    CustomName = 'TLAB-15', 
    Color = Color3.fromRGB(255, 0, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "A-59" then
ESP:AddObjectListener(Workspace.Entities.["A-59"], { 
    Name = "Torso", 
    CustomName = 'A-59', 
    Color = Color3.fromRGB(0, 75, 255), -- Color
    IsEnabled = "whatever" 
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "xh221" then
ESP:AddObjectListener(Workspace.Entities["xh221"], { 
    Name = "Torso", 
    CustomName = 'the xrime', 
    Color = Color3.fromRGB(0, 255, 255), -- Color
    IsEnabled = "whatever" 
})
ESP.whatever = true
...
for i, v in pairs(game:GetService("Workspace").Entities:GetChildren()) do
 if v.Name == "xh246" then
ESP:AddObjectListener(Workspace.Entities["xh246"], { 
    Name = "Torso", 
    CustomName = 'the xrime', 
    Color = Color3.fromRGB(182, 0, 255), -- Color
    IsEnabled = "whatever" 
